...
Generic -> Word<~quoted, h-reg1,wff=/([^\s]{4,})/, kwset=~["имена", "стоп_слова"]>+[gnc-agr];
...
Location ->  Noun<~quoted, h-reg1, gnc-agr[1], rt> Word<~quoted, h-reg1, gnc-agr[1]>+ | Noun<~quoted, h-reg1, gnc-agr[1]> Word<~quoted, l-reg, gnc-agr[1]>+;
